    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start gap-8">
          {/* Mission Card */}
          <div className="flex-1 bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 transform md:-translate-y-4">
          ...
          {/* Vision Card */}
          <div className="flex-1 bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 transform md:translate-y-14">
            <div className="flex items-center mb-4">
